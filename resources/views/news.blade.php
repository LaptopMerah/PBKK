                ...
                <div class="items-center mx-auto mb-6 space-y-4 max-w-screen-lg sm:flex sm:space-y-0 ">
                    <div class="relative w-full">
                        ...
                        <input
                            ...
                            placeholder="Search for news" type="search" id="search" name="search"
                            autocomplete="off">
                    </div>
                    <div>
                        <button type="submit"
                    ...
                    <article
                        ...
                        <a href="/news/{{ $post->slug }}">
                            <div class="relative" style="padding-top: 75%;">
                                <img class="absolute top-0 left-0 w-full h-full rounded-t-lg object-cover"
                                    src="{{ $post->image }}" alt="" />
                            </div>
                        </a>
                        <div class="p-5">
                            ...
                            <div class="flex justify-between items-center">
                                <a href="/news?authors={{ $post->user->username }}"
