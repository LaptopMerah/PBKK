        ...
        <div class="container max-w-screen-xl px-6 py-10 mx-auto">
            <div class="lg:flex lg:items-center lg:-mx-10">
                <div class="lg:w-1/2 lg:mx-10">
                    <h1 class="text-2xl font-semibold text-gray-800 capitalize dark:text-white lg:text-3xl">Let’s talk
                    </h1>
                ...
                <div class="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                    <img class="hidden object-cover mx-auto rounded-full lg:block shrink-0 w-96 h-96"
                        src="{{ asset('Profile.JPG') }}" alt="">

                    <div class="mt-6 space-y-8 md:mt-8">
                        <a class="flex items-start -mx-2" href="https://maps.app.goo.gl/ruHgM17CGV3Fr3vs5"
                            target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="w-6 h-6 mx-2 text-blue-500 dark:text-blue-400" fill="none" viewBox="0 0 24 24"
                        ...
                        <a class="flex items-start -mx-2" href="mailto:iqballramadhan18@gmail.com" target="_blank">
                            ...
                            <span
                                class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">iqballramadhan18@gmail.com</span>
                        </a>
                    </div>
                    ...
                    <div class="mt-6 w-80 md:mt-8">
                        ...
                        <div class="flex mt-4 -mx-1.5 ">
                            <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500"
                                href="https://www.twitter.com/IqballRmdhn18" target="_blank">
                            ...
                            <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500"
                                href="https://www.linkedin.com/in/iqballramadhan" target="_blank">
                            ...
                            <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500"
                                href="https://www.facebook.com/iqbaladon" target="_blank">
                                <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500"
                                href="https://www.instagram.com/iqballl_18" target="_blank">
                                <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
